...
#hides python window so it cannot be stopped
...
pymsgbox.alert(icon=4096 + 16, text="You got hacked lol", title="Hi ")
...
time.sleep(5)
# To delete all the x marks, open cmd and run this:
#                                        1.Go to desktop directory using cd
#                                        2.' del "UR NEXT*" '
